...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='outputs/miniimagenet',
    ...
    # parser.add_argument('--cdfsl_domains', nargs="+", default=['ISIC', 'ChestX', 'CropDisease', 'EuroSAT'], help='CDFSL datasets')
    parser.add_argument('--cdfsl_domains', nargs="+", default=['CropDisease', 'ChestX', 'ISIC', 'EuroSAT'], help='CDFSL datasets')
