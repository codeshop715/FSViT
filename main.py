...
from datasets.__init__ import get_loaders
...
def main(args):
    ...
    if utils.is_main_process():
        ...
        # with (output_dir / "tiaoshi.txt").open("a") as f:
        #     f.write(" ".join(sys.argv) + "\n")
    ...
    ##############################################
    # Test
    test_stats = evaluate(data_loader_val, model, criterion, args.device, args.seed+10000)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            data_loader_train, model, criterion, optimizer, epoch, args.device,
        ...
        if args.output_dir:
            ...
            for checkpoint_path in checkpoint_paths:
                state_dict = {
                    ...
                    # 'model': model_without_ddp.modules.state_dict(),
